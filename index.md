...
- [`radius_function()`](https://aavotins.github.io/egvtools/reference/radius_function.md)
  — multi-scale zonal statistics (dense/sparse). Currently hard coded to
  our filenames;

2.  intermediate wrapper around
...
- [`create_backgrounds()`](https://aavotins.github.io/egvtools/reference/create_backgrounds.md)
  — build consistent background rasters, guarding spatial cover,
  resolution, coordinate reference system, exact pixel matching, etc.;
...
- [`polygon2input()`](https://aavotins.github.io/egvtools/reference/polygon2input.md)
  — rasterize polygons to ultra-high-resolution template, handle
  background/mask;

- [`input2egv()`](https://aavotins.github.io/egvtools/reference/input2egv.md)
  — normalize/align ultra-high-resolution inputs to broader-resolution
  EGV output rasters with guards to template;
...
polygonised before
[`polygon2input()`](https://aavotins.github.io/egvtools/reference/polygon2input.md).
Multiple outputs of this function can be combined before creating EGVs.
